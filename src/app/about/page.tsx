...
export default function about() {
  ...
  return (
        <div className="bg-none justify-center items-center flex-col flex text-center">
            <div className="text-white text-7xl font-extrabold py-10 relative -left-2">
                <h1> About </h1>
            </div>
            <div className="text-white text-2xl bg-sky-200 rounded-xl w-3/4 mx-auto pb-4 leading-loose px-5 py-5">
                <p>
                    ...
                    <a href="mailto:ashane1230@gmail.com" className="text-blue-800 underline" target = "_blank">
